...
f=open("erato_script1")
javascript = f.read()
f.close()


firstpart = '''<div class="row"><div class="column" style="background-color:#aaa;">'''

middlepart = '''</div><div id="resultContainer" class="column" style="background-color:#eee;">'''
...
class MyServer(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        self.wfile.write(bytes("<div class=\"drop-zone\" id=\"drop-zone1\">Drop files here and the content will be put in the text area</div>","utf-8"))
